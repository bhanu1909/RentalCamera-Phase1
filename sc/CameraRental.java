...
Camera camera1 = new Camera(1, "Nikon", "Pixel23", 400.0, true);
Camera camera2 = new Camera(2, "Sony", "Blackwing", 250.0, true);
Camera camera3 = new Camera(3, "Hasselblade", "stills20", 350.0, true);
...
userList.add(new User("bh", "pn", 0.0));
userList.add(new User("ms", "sm", 0.0));
...
{
System.out.println(" ERROR : TRANSACTION FAILED DUE TO INSUFFICIENT WALLETBALANCE. PLEASE DEPOSIT THE AMOUNT TO YOUR WALLET");
}
break;
}
}
